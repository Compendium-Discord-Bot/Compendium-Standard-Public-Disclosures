...
> **Age requirement**: Compendium runs on Discord, which requires you to be at least 13 years old. By using Compendium, you confirm you meet that requirement. Depending on where you live, a higher minimum age restriction to interact with online services may apply. If these restrictions apply to you, the more restrictive restriction takes precedence over Discord's requirement.
...
- To deliver Compendium's service of writing management for yourself and for servers on Discord, and knowledge management, within servers on Discord.
...
Everything we store, we store because we need it to run the service - not just because we can.

- **Your Discord data and documents**: We need this to actually provide Compendium. Without it, there is no service. *([GDPR: contract performance, Art. 6(1)(b)](https://gdpr-info.eu/art-6-gdpr/#:~:text=processing%20is%20necessary%20for%20the%20performance%20of%20a%20contract%20to%20which%20the%20data%20subject%20is%20party%20or%20in%20order%20to%20take%20steps%20at%20the%20request%20of%20the%20data%20subject%20prior%20to%20entering%20into%20a%20contract; "GDPR – Art. 6(1)(b)"))*
...
- **Translation contributions**: Retained for as long as the contribution is active and in use. Deleted when superseded by an updated contribution.
...
- **Rectification / Correction**: If any data we have is inaccurate, you have the right to request corrections. *([GDPR Art. 16](https://gdpr-info.eu/art-16-gdpr/#:~:text=The%20data%20subject%20shall%20have%20the%20right%20to%20obtain%20from%20the%20controller%20without%20undue%20delay%20the%20rectification%20of%20inaccurate%20personal%20data%20concerning%20him%20or%20her.%202Taking%20into%20account%20the%20purposes%20of%20the%20processing%2C%20the%20data%20subject%20shall%20have%20the%20right%20to%20have%20incomplete%20personal%20data%20completed%2C%20including%20by%20means%20of%20providing%20a%20supplementary%20statement. "GDPR – Art. 16") / [CCPA](https://oag.ca.gov/privacy/ccpa))*
- **Deletion**: You can request deletion of your data, with the exception of: Infractions and their content, and history pertinent to infractions.
- **Data Portability**: You can request a copy of your data in a machine-readable format.
- **Objection**: If we're processing your data based on our interests rather than a contract (e.g., infraction records), you can ask us to stop. We'll stop unless we have a compelling reason not to. *([GDPR Art. 21](https://gdpr-info.eu/art-21-gdpr/ "GDPR – Art. 21"))*
...
Not every data right applies in every circumstance. These limitations exist not to disadvantage you, but because some data serves purposes that would be undermined if it could be freely modified or deleted on request. Infraction records, for example, exist to protect all users of the service, not just the user to which they relate. Allowing a user to erase or alter that record would compromise our ability to keep the service safe for everyone.

Every limitation listed here has a specific, documented reason. None abridge your rights generally - they apply only to the data categories and circumstances described.

#### 1.1. Infraction Data

1. Reporter and infraction data is confidential and will not be shared.
2. The infraction summary record, including what happened, when, appeal outcome, and actions taken as a result, is retained indefinitely and will not be deleted except as required by applicable law. Evidence associated with an infraction follows retention rules in §III.
...
- Backups that are never restored will expire in 1 year from the time that each backup was created, at which point the data is gone.
