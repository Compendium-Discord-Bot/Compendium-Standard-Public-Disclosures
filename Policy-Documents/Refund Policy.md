...
We currently offer no paid services at this time. All of the below reflects future policy transparency efforts and may be subject to change. As always, we will commit any updates to the [#transparency-hub](https://discord.com/channels/1232458290563387392/1345476136867594250 "Compendium Support Hub – Transparency Hub") channel in our Support Server on Discord.

Nothing in this Refund Policy limits or excludes any rights that you may have under applicable consumer protection laws. Where local law grants you rights that are more favorable than this policy, those rights will apply.

## I. Summary

We at Compendium stand by our commitment to provide a great product. If you are dissatisfied with what we have provided, we invite you to please seek a refund quickly and tell us how we can improve!

The Policy describes guarantees to you as a customer of our refund commitments, and provides methods required to remediate any issues.

## II. Eligibility & Limitations

### 1. Memberships

In order to be eligible for a refund, you must be an existing or former subscriber to any premium subscription tiers and must contact us through valid channels, see **§III(1) Acceptable Processes**.

### 2. Timeline Eligibility

1. Refund requests submitted within 90 days of any purchase are eligible for refund to original tender.
2. Refund requests submitted in excess of 90 days are not eligible for a refund.

### 3. Refund Limitations

Because we stand by our product, we limit refund eligibility to include no more than 5 transactions in a 365-day timespan, and 7 transactions over your entire subscription history. We welcome feedback on how we can improve first.

### 4. Promotions & Discounts

The original, higher value of the discounted item will not be refunded. Only the amount you actually paid, excluding any value covered by a discount or gift code, will be refunded.

## III. Process

When issuing a refund, we presume that you are dissatisfied with Compendium or it has fallen into disuse for you. As a result of seeking a refund, any live subscription will also be cancelled.

### 1. Acceptable Processes

In order to receive the quickest and best support possible, we need to be able to validate your purchase. Please follow one of the two methods below:

1. Contact us in our Support Server using the Billing Ticket template as the user linked to the premium subscription.
2. Contact us via our email at support@`[WIP - Website domain]` including the following:
   1. Your intent in seeking a refund;
   2. The Discord User ID for the user linked to the subscription;
   3. All related Invoice IDs which you are using to seek refunds;
   4. `[WIP - Some other identifier to prove who you say you are.]`
...
## IV. Refund Ineligibility

Under extreme circumstances, users may void their ability to receive a refund.
