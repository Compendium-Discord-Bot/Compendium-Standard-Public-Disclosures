...
This Subscriber Agreement governs the purchase and use of premium subscriptions and other paid services offered by Compendium ("COMPENDIUM", "WE", "OUR", or "US").

By purchasing, renewing, or otherwise maintaining a subscription with Compendium, you agree to be bound by this Agreement, our [Terms of Service](Terms-of-Service.md "Terms of Service – Compendium Standard Public Disclosures"), and all other policies incorporated herein by reference.

Nothing in this Agreement limits any rights that may be afforded to you under applicable law.

---

## I. Purpose

Compendium offers optional premium subscriptions and paid features that provide additional benefits and functionality beyond those available to free users.
...
Compendium subscriptions are offered on a recurring basis. Subscriptions may vary by:

* Price;
* Billing frequency;
* Features;
* Included benefits;
* Limitations or quotas.

Unless otherwise specified at the time of purchase, subscriptions automatically renew at the end of each billing period until cancelled.

Subscription benefits begin once payment has been successfully processed and validated in our systems.
...
### 2. Discontinued Offerings

Compendium does not have any subscription plans that have been discontinued.

---

## IV. Billing and Renewals

### 1. Regular Payments

By purchasing a subscription, you authorize Compendium and its payment processors to charge your selected payment method:

* Immediately upon purchase;
* Upon each renewal date; and
* For any applicable taxes, fees, or charges disclosed at checkout.
* Any pro-rated amount less than the total base subscription amount, if circumstances apply.

Unless cancelled before renewal, subscriptions automatically renew for successive billing periods equal to the original subscription term.

You are responsible for maintaining accurate billing information and ensuring that your payment method remains valid.

### 2. Pro-Rated Payments

#### A. Cause for altered rates

Under certain conditions not related to any promotion or discount, we may charge less than the full amount that your subscription renewal payment would normally cost.
...
The formulas for how we charge a pro-rated amount is as follows, and depending on billing cycle and when the offering was discontinued.
...
###### a. Renewal before date *t*

> ***p** = **a** × (**d** ÷ **f**)*

###### b. Renewal on the same date as *t*

Your renewal payment will not occur as of ***t*** as previously scheduled, and your subscription will be cancelled on that same date.

##### iii. Annual Cycle

Depending on when your subscription renews, we may treat these differently, both to respect our commitments to provide you adequate notification, and to ensure that your support as a customer is respected.
...
Your renewal payment will not occur as of ***t*** as previously scheduled, and your subscription will expire on that same date.

###### c. Renewal after date *t*

Your subscription will expire when it would otherwise be scheduled to renew. If your renewal date is not less than three days after ***t***, one additional notification will be sent to you to three days prior to this expiration date to update your subscription.
...
Cancellation prevents future renewals but does not automatically entitle you to a refund.

Unless otherwise required by law or expressly stated in our policies, subscription benefits remain active until the end of the current billing period.
...
Nothing in the Refund Policy limits any rights that may apply under applicable consumer protection laws.
...
Unless otherwise prohibited by law, the specific terms of a promotion govern that promotion in the event of any conflict with this Agreement.

Compendium reserves the right to modify, suspend, or discontinue promotions at any time, subject to any commitments already made to participating subscribers and any requirements imposed by applicable law.
...
* Payment systems are being abused;
...
We strive to make our subscriptions straightforward, transparent, and fair, and we encourage subscribers to contact us whenever questions or concerns arise regarding their purchases or benefits.

Questions about policy can be raised at any time on our support server, or by email at policy@`[WIP - Website domain]`.
