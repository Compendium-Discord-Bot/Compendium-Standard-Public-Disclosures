...
2. "GUILD" refers to any Discord guild, commonly referenced as a Discord server.
...
Users claiming account compromise may be required to:

* Secure their account and associated email addresses;
* Reset passwords or revoke access sessions;
* Cooperate with any investigation;
* Provide additional information reasonably requested by the Service.

The Service is not obligated to reverse moderation actions, restore benefits, or issue refunds solely because a user alleges that an account was compromised.

Repeated claims of account compromise, failure to take reasonable security measures, or circumstances suggesting abuse of this process may result in the Service declining to grant further relief.
...
- Links and files attached to documents during whole lifetime of the document's modification history
...
- Your infraction history (if you violate our policies)
...
## IV. Bot Usage and Commands

Our bot has specific commands and features. By using these commands and features, you agree that:

1. **Service is provided As-Is**: Compendium, its features, and its agreements between us and you are provided to you in the form which is presented to you. We may add, modify, or remove features and agreements from time to time and will give reasonable notification in advance of major changes, especially when it might affect your stored data.
...
### 1. Prohibited Storage & Distribution
...
5. Electronically harmful or personally malicious materials such as malware, spyware, viruses, zip bombs, etc.
6. Materials glorifying or promoting terrorism or self-harm.
...
9. Any media or text which depicts any person or fictional character plausibly under the age of 18 involved in sexual acts or portrayed in any way intended to be sexually gratifying.
...
A history of infractions is maintained, and repeated offenses will generally lead to greater penalties.
