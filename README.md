...
As we value transparency, documents that we publish and maintain out of goodwill and for yours and our mutual benefit.
...
If the date in that file is more than 90 days old, or the file is removed entirely, treat that as a signal that we were not able to honor the commitment stated in its purpose. We recommend watching this repository for changes.

### Compliance Documents

Documents that we are required to publish such as attributions.
...
Other documents that are important to maintain but do not fit into any of the above categories.
...
Significant changes to any document are announced in the [#transparency-hub](https://discord.com/channels/1232458290563387392/1345476136867594250 "Compendium Support Hub – Transparency Hub") channel in the Compendium Support Discord server.
